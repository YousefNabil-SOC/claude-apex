...
name: gs-skillify
version: 1.0.0
description: "Codify a successful gstack scrape/browser flow into a permanent browser-skill on disk (scrape-specific). CARL TRIGGERS: make this a skill, skillify, turn into a skill, save this workflow, capture this pattern. SOURCE: garrytan/gstack/skillify, integrated as gs-skillify on 2026-05-29."
allowed-tools:
  - Bash
  - Read
  - Write
